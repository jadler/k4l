...
function(CONFIGURE_PACKAGE_CONFIG_FILE _outputFile)

  SET (_inputFile "${CMAKE_SOURCE_DIR}/Config.cmake.in")
...
####################################################################################")
  ...
  MESSAGE (STATUS "configuring file: ${_inputFile}")
  configure_file("${_inputFile}" "${_outputFile}" @ONLY)
  MESSAGE (STATUS "configuring file: ${_outputFile} -- done")
